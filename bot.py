...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        f"👋 Вітаю! я твій помічник! я допоможу оаублікувати оголошеня га каналі Для своїх",
        f"Я допоможу вам опублікувати твоє оголошення на канал {CHANNEL_ID}. Оберіть потрібну дію на панелі нижче:",
